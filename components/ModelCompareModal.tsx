 ...
 * limits and error sanitising, and writes nothing to the database. The normal
...
export default function ModelCompareModal({
  ...
  return (
    <Modal
      ...
      description={`Send one prompt to ${MIN_MODELS}–${MAX_MODELS} models at once. Nothing here is saved to your history.`}
    ...
    >
      {options.length === 0 ? (
        ...
        <>
          ...
          <label htmlFor="compare-prompt" className="mb-1.5 mt-5 block text-xs font-medium text-neutral-400">
            Prompt
          </label>
          <textarea
            id="compare-prompt"
            ...
            >
              {columns.map((column) => (
                ...
                >
                  ...
                  <div className="max-h-80 min-w-0 overflow-y-auto px-3 py-2.5">
                    {column.status === "error" ? (
